...
"""readlut.py: A temporary script to load and check *.lut files"""
...
FILENAME = './lut_SZ_S_9_41_1mom.lut'
...
if __name__ == "__main__":
    lut = load_lut(FILENAME)
    print(lut.axes)
    print(lut.axes_names)
    print(lut.axes_limits)
    print(lut.axes_step)
    print(lut.value_table)
